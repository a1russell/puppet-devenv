class devenv ($user = 'vagrant') {
  ...
  augeas { 'add idea launcher to panel':
    ...
    changes => [
      'defvar plugins channel/property[#attribute/name="plugins"]',
      'defvar plugin15 $plugins/property[#attribute/name="plugin-15"]',
      'set $plugin15/#attribute/name plugin-15',
      'set $plugin15/#attribute/type string',
      'set $plugin15/#attribute/value launcher',
      'defvar items $plugin15/property[#attribute/name="items"]',
      'set $items/#attribute/name items',
      'set $items/#attribute/type array',
